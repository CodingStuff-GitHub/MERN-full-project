...
import { fetchPasswordUpdate } from "../../state_management/user/updateSlice";
...
const ResetPassword = () => {
  ...
  const registerSubmit = (e) => {
    ...
    registerFormData.set("oldPassword", oldPassword);
    registerFormData.set("newPassword", newPassword);
    registerFormData.set("confirmPassword", confirmPassword);
    dispatch(fetchPasswordUpdate(registerFormData)).then(() => {
